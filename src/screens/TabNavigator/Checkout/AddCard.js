                    ...
                    {({ values, errors, setFieldTouched, touched, handleChange, setFieldValue, isValid, handleSubmit }) => (
                        <View style={{ marginTop: 30, padding: 10, flex: 3, marginHorizontal: 20 }}>
                                        ...
                                        <View style={styles.contentContainer}>
                                            <View style={styles.content}>
                                                <MonthPicker
                                                    ...
                                                    nextIcon={<Ionicons name="chevron-forward" size={30} color={Colors.black} />}
                                                    prevIcon={<Ionicons name="chevron-back" size={30} color={Colors.black} />}
                                                />
                            ...
                            <View style={styles.switch} >
                                ...
                                <Text style={styles.toggle} > Make this my defalut payment </Text>
                                <SwitchToggle
                                    switchOn={isEnabled}
                                    onPress={() => {
